...
package fr.ua.iutlens.s201.controller.client;

import java.io.IOException;

import fr.ua.iutlens.s201.controller.IController;
import fr.ua.iutlens.s201.controller.stock.ModifController;
import fr.ua.iutlens.s201.model.Client;
...
public class DetailController implements IController{
	...
	@FXML
	private ListView<Client> listeObject;
	...
	public void setStage(Stage stage) {
		...
		descriptifDetail.setText("Selectionnez à gauche un client!");
			  ...
			  return new ListCell<>() {
			    ...
			    public void updateItem(Client client, boolean empty) {
			        ...
			        if (empty || (client == null)) {
			          ...
			          setText(client.getCodeC());
			        }
			      }
			    };
			});
		listeObject.setItems(
				entreprise.getClients());
	...
	public void onModifier() throws IOException{
		if(listeObject.getSelectionModel().getSelectedIndex() == -1)
			return;
		FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("../../view/client/modif.fxml"));
		Parent viewContent = fxmlLoader.load();
